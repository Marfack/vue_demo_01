<template>
  <div class="tab-bar">
    <el-menu
      ...
      :router="true"
      @select="handleSelect"
      background-color="rgb(56, 122, 184)"
      text-color="#fff"
      active-text-color="rgb(229, 195, 155)"
    >
      ...
      <div style="width: 40px"></div>
      <el-menu-item style="height: 100px; width: 220px; text-align: center; font-size: 22px; padding-top: 20px" index="/user_evaluation">用户评价</el-menu-item>
      <div style="width: 40px"></div>
